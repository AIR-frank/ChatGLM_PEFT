...
trainer = Trainer(tokenizer=tokenizer, config=config, from_pretrained='/root/model/chatglm3-6b', loader_name='ChatGLM_Chat', data_path='qa_dataset', max_length=3200, batch_size=2, task_name='qa_dataset')
